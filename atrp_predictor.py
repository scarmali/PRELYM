...
import itertools
import numpy as np
from ssbio.protein.structure.properties.dssp import get_dssp_df_on_file as dsspf
from biopandas.pdb import PandasPdb
